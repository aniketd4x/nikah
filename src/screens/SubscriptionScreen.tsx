  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-12 space-y-10 pb-24 md:pb-12">
      ...
      <div className="text-center max-w-2xl mx-auto space-y-3">
        <div className="inline-flex items-center gap-1.5 bg-gold-100 text-gold-900 px-3.5 py-1 rounded-full text-xs font-bold border border-gold-300">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 items-stretch">
        {SUBSCRIPTION_PLANS.map((plan) => {
          ...
          return (
            <div
              key={plan.id}
              className={`relative rounded-[2rem] p-6 sm:p-8 flex flex-col justify-between border-2 transition-all duration-300 ${
                plan.popular
      ...
      <div className="bg-emerald-950 text-cream-50 rounded-3xl p-6 sm:p-10 border border-gold-500/30 shadow-card flex flex-col md:flex-row items-center justify-between gap-6">
