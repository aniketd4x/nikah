...
export const VerificationScreen: React.FC = () => {
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-8 space-y-6 sm:space-y-8 pb-28 md:pb-12">
      ...
      <div className="bg-gradient-to-br from-emerald-950 via-emerald-900 to-emerald-950 text-cream-50 rounded-[2rem] p-6 sm:p-8 border border-gold-500/30 shadow-card flex flex-col md:flex-row items-center justify-between gap-6">
        <div className="space-y-2 text-center md:text-left">
          <div className="inline-flex items-center gap-2 bg-emerald-900/80 px-3 py-1 rounded-full text-gold-300 text-xs font-bold border border-gold-500/30 shadow-sm">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-5">
        {/* 1. Mobile */}
        <div className="bg-white/95 backdrop-blur-md rounded-[2rem] p-5 sm:p-6 border border-cream-300/80 shadow-soft space-y-3">
          <div className="flex items-center justify-between">
            ...
            <span className="bg-emerald-100 text-emerald-800 text-xs font-bold px-2.5 py-0.5 rounded-full flex items-center gap-1 shadow-sm">
        ...
        <div className="bg-white/95 backdrop-blur-md rounded-[2rem] p-5 sm:p-6 border border-cream-300/80 shadow-soft space-y-3">
          <div className="flex items-center justify-between">
            <div className="w-10 h-10 rounded-2xl bg-gold-100 text-gold-900 flex items-center justify-center shadow-sm">
