      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
            ...
            return (
              <div
                ...
                className={`p-4 rounded-3xl border cursor-pointer transition-all flex items-start gap-3.5 ${
                  isSelected
                    ? 'bg-emerald-900 text-white border-emerald-900 shadow-card'
        ...
        {activeArticle && (
          <div className="lg:col-span-8 bg-white rounded-[2rem] p-6 sm:p-10 border border-cream-300 shadow-card space-y-6">
            ...
            <h2 className="text-2xl sm:text-3xl font-serif font-bold text-emerald-950 leading-tight">
              {activeArticle.title}
            </h2>
            <p className="text-xs sm:text-sm text-charcoal-600 leading-relaxed italic bg-cream-50 p-3.5 rounded-2xl border border-cream-200">
