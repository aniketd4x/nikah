...
export const DiscoverScreen: React.FC = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8 py-4 sm:py-6 space-y-5 pb-28 md:pb-12 select-none">
      ...
      <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-3 bg-white p-4 rounded-3xl border border-cream-300 shadow-soft">
        <div>
          ...
          <h1 className="text-lg sm:text-xl font-serif font-bold text-emerald-950 mt-0.5">
