...
export const LoginScreen: React.FC = () => {
  ...
  return (
    <div className="min-h-[80vh] flex items-center justify-center px-4 py-12">
      <div className="w-full max-w-md bg-white rounded-3xl p-6 sm:p-8 border border-cream-300 shadow-card space-y-6">
        {/* Header */}
        <div className="text-center space-y-2">
          <div className="inline-block" onClick={() => navigateTo('landing')}>
            <Logo size="lg" variant="emerald" />
          </div>
          <h2 className="text-2xl font-serif font-bold text-emerald-950 pt-2">
            Welcome Back
          </h2>
        ...
        <div className="bg-cream-100 p-3 rounded-2xl border border-cream-200 space-y-2">
          ...
          <div className="grid grid-cols-2 gap-2">
            <button
              ...
              className="py-1.5 px-2.5 rounded-xl bg-white text-emerald-950 text-xs font-semibold border border-cream-300 hover:border-emerald-700 flex items-center justify-center gap-1 shadow-sm"
            >
        ...
        <form onSubmit={handleLogin} className="space-y-4">
          ...
          <button
            type="button"
            onClick={() => handleDemoLogin('groom')}
            className="w-full py-2.5 px-4 rounded-2xl border border-cream-300 bg-white hover:bg-cream-50 text-xs font-semibold text-charcoal-700 flex items-center justify-center gap-2 shadow-sm transition-colors"
          >
